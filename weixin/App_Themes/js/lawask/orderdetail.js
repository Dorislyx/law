...
window.orderdetail=(function(){
	...
	/*$('.pay_btn').click(function() {
		window.location.href='http://weiq.bjqttd.com/index.php/api/Index/g_weixinzhifu?&ordercode=W1444702958oLw&money=0.01';
		//$('.bighide').fadeIn(200);			
	});*/
	
		//获取订单信息
		function  orderinfo(){
			server = 'Index/falvzixun_';
